		...
		<div class="container">
			<div class="row">
				<div class="logo col-md-4">
					<div>
						<a href="#">
							<img src="<?php echo base_url() ?>/assets/images/kita_aja_transparan.png" style="width:100px; height:auto;">
						</a>
					</div>
				</div>
				<div class="col-md-8">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 cBusiness">
					<h3>Technology is Yours</h3>
					<h4>Tim kitaaja, generasi muda pengembang produk digital pemecah masalah teknologi Anda.</h4>
				</div>
			</div>
		</div>
		<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 wwa">
					...
					<h3>Who We Are?</h3>
					<h4>Kitaaja. Generasi muda, kreative dan berbakat yang bergerak untuk kemajuan teknologi Indonesia.<br> Kami akan menjawab tantangan IT yang Anda hadapi.<br>Layanan kami berupa aplikasi dekstop, website, mobile. Tantangan Anda penggerak kami untuk menjadi solusi.</h4>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-xs-12 cont">
					<ul>
						<li><i class="fa fa-home"></i>Teknik Informatika ITS Lt. 3 IF-303</li>
						<li><i class="fa fa-phone"></i>+62896 9632 2737</li>
						<li><a href="#"><i class="fa fa-envelope"></i>official.kitaaja@gmail.com</li></a>
						<li><a href="#"><i class="fa fa-twitter"></i>Twitter</li></a>
						<li><a href="#"><i class="fa fa-facebook-square"></i>Facebook</li></a>
						<li><img src="<?php echo base_url() ?>/assets/images/line.png" style="width:13px; height:auto;"> natasari20</li>
					</ul>
				</div>
			</div>
		</div>
